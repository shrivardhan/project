...
def main(model):
    ...
    # sliding window model
        ...
        print(val)
        print(ze)
        plt.plot(swm, label = 'Sliding:Markov')
...
# to run, python stma.py [i|s] : i = iid model,s = sliding window model, python stmal.py for results of sliding window simulations.
